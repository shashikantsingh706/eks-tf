...
resource "aws_iam_policy" "cloud_watch_policy" {
  name = "legacy-imp-cloud-watch-policy"
  policy = jsonencode({
    "Version" : "2012-10-17",
    "Statement" : [
      {
...
resource "aws_iam_policy" "autoscaler" {
  name        = "legacy-imp-autoscaler-policy"
...
resource "aws_eks_node_group" "nodes_general" {
  ...
  node_group_name = "legacy-imp-node-group"
